...
CHAPTER = "ch02_gbpjpy_spread_sensitivity"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Chapter #2: GBPJPY spread sensitivity."
    )
    parser.add_argument(
    ...
    run_bb_mr_cases(
        ...
        cases=[
            ("low_spread_0p9sen", GBPJPY_SPREAD_LOW),
            ("mid_spread_1p7sen", GBPJPY_SPREAD_MID),
            ("high_spread_2p5sen", GBPJPY_SPREAD_HIGH),
        ],
        cache_root=args.cache_root,
        output_dir=output_dir,
        output_prefix="bb_mr_gbpjpy_spread_sensitivity",
    )
    return 0
